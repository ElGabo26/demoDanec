...
# --- cargar índice ---
INDEX_FILE = r"ModeloGabriel\tools\kb_index.npz"
META_FILE = r"ModeloGabriel\tools\kb_meta.json"
...
with open(r"ModeloGabriel\tools\instruccions.txt", "r", encoding="utf-8") as f:
        instruccions = f.read()
